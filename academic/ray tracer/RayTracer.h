...
// Raytracing
void buildScene(int sceneSelect, struct object3D **object_list, struct pointLS **light_list, struct textureNode **texture_list);											// Scene set up. Defines objects and object transformations
...
void *rtThread(void *rtargs);

//Set pixel function
void setPixel(struct image *im, int i, int j, colourRGB c);
